...
if [ -n "${POLICIES_OVERRIDE:-}" ]; then read -ra POLICIES <<< "$POLICIES_OVERRIDE"; else POLICIES=(Qwen/Qwen3-30B-A3B-Instruct-2507 t2T_final mit-oasys/rlm-qwen3-30b-a3b-v0.1); fi
